...
def parse_arguments():
    ...
    assert sys.argv[2] in ['Concept_XtoC', 'Independent_CtoY', 'Sequential_CtoY',
                           ...
                           'TTI', 'Robustness', 'HyperparameterSearch'], \
                            f"Please specify valid experiment. Current: {sys.argv[2]}"
    ...
    if experiment == 'Probe':
        raise NotImplementedError("Probe experiment is not implemented yet.")
        return (probe.parse_arguments(parser),)

    elif experiment == 'TTI':
        raise NotImplementedError("TTI experiment is not implemented yet.")
        return (tti.parse_arguments(parser),)

    elif experiment == 'Robustness':
        raise NotImplementedError("Robustness experiment is not implemented yet.")
        return (gen_cub_synthetic.parse_arguments(parser),)

    elif experiment == 'HyperparameterSearch':
        raise NotImplementedError("Hyperparameter search is not implemented yet.")
